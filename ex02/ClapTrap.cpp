...
{
    std::cout << "the ClapTrap default constructor was called" << std::endl;
}
...
{
    std::cout << "The ClapTrap copy constructor was called" << std::endl;
    name = other.name;
...
{
    std::cout << "The ClapTrap copy assigment constructor was called" << std::endl;
    if (this != &other)
    {
        name = other.name;
        attackDamage = other.attackDamage;
